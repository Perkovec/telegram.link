...
Updates.prototype.getState = (callback) => {
    return utility.callService(api.service.updates.getState, this.client, this.client._channel, callback, arguments);
}
Updates.prototype.getDifference = (flags, pts, pts_total_limit, date, qts, callback) => {
    return utility.callService(api.service.updates.getDifference, this.client, this.client._channel, callback, arguments);
}
Updates.prototype.getChannelDifference = (flags, force, channel, filter, pts, limit, callback) => {
    return utility.callService(api.service.updates.getChannelDifference, this.client, this.client._channel, callback, arguments);
}
