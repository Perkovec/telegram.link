...
var mt = require('@wfjsw/telegram-mt-node');
var api = require('./api');
...
function Client(app, dataCenter) {
    ...
    this.channels = new (require('./api/channels'))(this);
    this.help = new (require('./api/help'))(this);
    this.phone = new (require('./api/phone'))(this);
    this.photos = new (require('./api/photos'))(this);
    this.updates = new (require('./api/updates'))(this);
    this.upload = new (require('./api/upload'))(this);
